 ...
 *
 * Descricao: Programa de testes funcoes GerarDistribuicaoInicial, MostrarMonitor, LimparMonitor e novamente MostrarMonitor
 *
 * $Author: felipe.farias $
 * $Date: 2024/08/19 01:12:28 $
 * $Log: aula0703.c,v $
 * Revision 1.2  2024/08/19 01:12:28  felipe.farias
 * correcao
 *
 * Revision 1.1  2024/08/17 20:34:36  felipe.farias
 * Initial revision
 *
 *
 ****************************************************************************************************************************/
...
int main(int argc, char **argv)
{
	...
	unsigned contadorArgumento;
  	...
  	tipoErros resultanteDistribuicao, resultanteMonitor, resultanteLimparMonitor;
