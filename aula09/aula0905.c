 ...
 *
 * Descricao: Arquivo de testes para as funcoes do aula0901.c com argumento opcao no terminal
 *
 * $Author: felipe.farias $
 * $Date: 2024/08/24 05:55:58 $
 * $Log: aula0905.c,v $
 * Revision 1.2  2024/08/24 05:55:58  felipe.farias
 * correcao
 *
 * Revision 1.1  2024/08/24 05:44:11  felipe.farias
 * Initial revision
 *
 *
 ************************************************************************************************/
...
void ExibirOpcoesCurtasInstrucao(void)
{
	...
	printf("  -d | -D: Converter um arquivo do formato Unix para o formato Microsoft (DOS);\n");
	printf("  -h | -H: Exibir esta mensagem que instrui o uso do programa;\n");
	printf("  -s | -S: Exibir o conteudo do arquivo;\n");
	printf("  -u | -U: Converter um arquivo do formato DOS para o formato Unix.\n\n");
}
		...
		case 'S':
			...
			if (resultanteExibirConteudo != sucesso)
			{
				switch (resultanteExibirConteudo)
				{
					...
					case tipoArquivoInvalido:
					printf("\n%sERRO: Arquivo esta no formato invalido, o arquivo deve estar em .c!%s\n\n", RED, RESET);
					break;
